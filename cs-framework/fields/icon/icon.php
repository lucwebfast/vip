...
class CSFramework_Option_icon extends CSFramework_Options {
  ...
  public function output() {
    ...
    echo '<a href="#" class="button button-primary cs-icon-add">'. __( 'Add Icon', 'agencies' ) .'</a>';
    echo '<a href="#" class="button cs-warning-primary cs-icon-remove'. $hidden .'">'. __( 'Remove Icon', 'agencies' ) .'</a>';
