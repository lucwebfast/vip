...
AGENCIES_Kirki::add_section( 'dt_site_skin_section', array(
	...
	AGENCIES_Kirki::add_field( $config, array(
		...
		'choices' => array(
			'blue'			=>	esc_attr__('Blue','agencies'),			'brown'			=>	esc_attr__('Brown','agencies'),
			'cadetblue'		=>	esc_attr__('Cadet Blue','agencies'),	'chilipepper'	=>	esc_attr__('Chili Pepper','agencies'),
			'cyan'			=>	esc_attr__('Cyan','agencies'),			'gold'			=>	esc_attr__('Gold','agencies'),
			'deeporange'	=>	esc_attr__('Deep Orange','agencies'),	'deeppurple'	=>	esc_attr__('Deep Purple','agencies'),
			'green'			=>	esc_attr__('Green','agencies'),			'lime'			=>	esc_attr__('Lime','agencies'),
			'magenta'		=>	esc_attr__('Magenta','agencies'),		'orange'		=>	esc_attr__('Orange','agencies'),
			'pink'			=>	esc_attr__('Pink','agencies'),			'purple'		=>	esc_attr__('Purple','agencies'),
			'red'			=>	esc_attr__('Red','agencies'),			'skyblue'		=>	esc_attr__('Sky Blue','agencies'),
			'teal'			=>	esc_attr__('Teal','agencies'),			'turquoise'		=>	esc_attr__('Turquoise','agencies'),
			'wisteria'		=>	esc_attr__('Wisteria','agencies'),		'yellow'		=>	esc_attr__('Yellow','agencies'),
		)
	));
