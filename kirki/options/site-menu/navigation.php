...
# Main menu
	AGENCIES_Kirki::add_section( 'dt_site_navigation_section', array(
		'title' => __( 'Main Menu', 'agencies' ),
		...
		AGENCIES_Kirki::add_field( $config, array(
			...
			'label'    => __( 'Menu Active Style', 'agencies' ),
			'section'  => 'dt_site_navigation_section',
			'default'  => agencies_defaults('menu-active-style'),
			'choices'  => array(
				"menu-default" => esc_attr__( 'Default','agencies'),
				"menu-active-with-icon menu-active-highlight" => esc_attr__( 'Highlight with Plus Icon','agencies'),
				"menu-active-highlight" => esc_attr__( 'Highlight','agencies'),
				"menu-active-highlight-grey" => esc_attr__( 'Highlight Grey','agencies'),
				"menu-active-highlight-with-arrow" => esc_attr__( 'Highlight with Arrow','agencies'),
				"menu-active-with-two-border" => esc_attr__( 'Two Border','agencies'),
				"menu-active-with-double-border" => esc_attr__( 'Double Border','agencies'),
				"menu-active-border-with-arrow" => esc_attr__( 'Border with Arrow','agencies'),
				"menu-with-slanting-splitter" => esc_attr__( 'Slanting Splitter','agencies'),
			)
		));
		...
		AGENCIES_Kirki::add_field( $config, array(
			...
			'label'    => __( 'Customize Menu BG ?', 'agencies' ),
			'section'  => 'dt_site_navigation_section',
			'default'  => agencies_defaults('customize-menu-bg-color'),
			'choices'  => array(
		...
		AGENCIES_Kirki::add_field( $config, array(
			...
			'label'    => __( 'Customize Menu Link Colors ?', 'agencies' ),
			'section'  => 'dt_site_navigation_section',
			'default'  => agencies_defaults('customize-menu-link'),
			'choices'  => array(
				'on'  => esc_attr__( 'Yes', 'agencies' ),
				'off' => esc_attr__( 'No', 'agencies' )
			)
		...
		AGENCIES_Kirki::add_field( $config, array(
			...
			'label'    => __( 'Menu link Color', 'agencies' ),
			'section'  => 'dt_site_navigation_section',
			'output' => array(
		...
		AGENCIES_Kirki::add_field( $config, array(
			...
			'label'    => __( 'Menu link hover Color', 'agencies' ),
			'section'  => 'dt_site_navigation_section',
			'output' => array(
		...
		AGENCIES_Kirki::add_field( $config, array(
			...
			'label'    => __( 'Active Menu Color', 'agencies' ),
			'section'  => 'dt_site_navigation_section',
			'output' => array(
		...
		AGENCIES_Kirki::add_field( $config, array(
			...
			'label'    => __( 'Active Menu BG Color', 'agencies' ),
			'section'  => 'dt_site_navigation_section',
			'output' => array(
...
# Sub menu
	AGENCIES_Kirki::add_section( 'dt_site_sub_menu_section', array(
		'title' => __( 'Sub Menu', 'agencies' ),
		'panel' => 'dt_site_menu_panel',
		'priority' => 2
	) );
		...
		AGENCIES_Kirki::add_field( $config, array(
			...
			'label'    => __( 'Sub Menu Wrapper Animation', 'agencies' ),
			'section'  => 'dt_site_sub_menu_section',
			'default'  => '',
			'choices'  => agencies_animations()
		));
		...
		# customize-sub-menu-wrapper
			AGENCIES_Kirki::add_field( $config, array(
				...
				'label'    => __( 'Customize Sub Menu Wrapper ?', 'agencies' ),
				'section'  => 'dt_site_sub_menu_section',
				'choices'  => array(
					'on'  => esc_attr__( 'Yes', 'agencies' ),
					'off' => esc_attr__( 'No', 'agencies' )
			...
			# Sub Menu Wrapper Background Color
				...
				AGENCIES_Kirki::add_field( $config, array(
					...
					'label'    => __( 'Custom BG - Sub Menu Wrapper', 'agencies' ),
					'section'  => 'dt_site_sub_menu_section',
					'choices'  => array(
						'on'  => esc_attr__( 'Yes', 'agencies' ),
						'off' => esc_attr__( 'No', 'agencies' )
				...
				AGENCIES_Kirki::add_field( $config, array(
					...
					'label'    => __( 'BG Color Type', 'agencies' ),
					'section'  => 'dt_site_sub_menu_section',
					'default'  => 'simple',
					'choices'  => array(
						'simple' => esc_html__('Simple','agencies'),
						'gradient' => esc_html__('Gradient','agencies')
					),
					'active_callback' => array(
						array( 'setting' => 'customize-sub-menu-wrapper', 'operator' => '==', 'value' => '1' ),
				...
				AGENCIES_Kirki::add_field( $config, array(
					...
					'label'    => __( 'Gradient BG 1', 'agencies' ),
					'section'  => 'dt_site_sub_menu_section',
					'choices' => array( 'alpha' => true ),
					'output' => array(
				...
				AGENCIES_Kirki::add_field( $config, array(
					...
					'label'    => __( 'Gradient BG 1 Stop (in %)', 'agencies' ),
					'section'  => 'dt_site_sub_menu_section',
					'default'	=> 30,
				...
				AGENCIES_Kirki::add_field( $config, array(
					...
					'label'    => __( 'Gradient BG 2', 'agencies' ),
					'section'  => 'dt_site_sub_menu_section',
					'choices' => array( 'alpha' => true ),
					'output' => array(
						array( 'element' => '', 'property' => 'background-color')
				...
				AGENCIES_Kirki::add_field( $config, array(
					...
					'label'    => __( 'Gradient BG 2 Stop (in %)', 'agencies' ),
					'default'	=> 50,
					'choices'     => array( 'min'  => '0', 'max'  => '100', 'step' => '1' ),
					'section'  => 'dt_site_sub_menu_section',			
					'active_callback' => array(
				...
				AGENCIES_Kirki::add_field( $config, array(
					...
					'label'    => __( 'Gradient Direction', 'agencies' ),
					'section'  => 'dt_site_sub_menu_section',
					'default'  => 'to top',
					'choices'  => array(
						'to top' => esc_html__('Bottom to Top','agencies'),
						'to bottom' => esc_html__('Top to Bottom','agencies'),
						'to right' => esc_html__('Left to Right','agencies'),
						'to left' => esc_html__('Right to Left','agencies'),
						'to top left' => esc_html__('Bottom Right to Top Left','agencies'),
						'to top right' => esc_html__('Bottom Left to Right Top','agencies'),
						'to bottom right' => esc_html__('Left Top to Bottom Right','agencies'),
						'to bottom left' => esc_html__('Right Top to Bottom Left','agencies'),
					),			
					'active_callback' => array(
						array( 'setting' => 'customize-sub-menu-wrapper', 'operator' => '==', 'value' => '1' ),
						array( 'setting' => 'allow-sub-menu-bg-color', 'operator' => '==', 'value' => '1' ),
			...
			# Sub Menu Wrapper Border
				...
				AGENCIES_Kirki::add_field( $config, array(
					...
					'label'    => __( 'Sub Menu Wrapper Border?', 'agencies' ),
					'section'  => 'dt_site_sub_menu_section',
					'choices'  => array(
						'on'  => esc_attr__( 'Yes', 'agencies' ),
						'off' => esc_attr__( 'No', 'agencies' )
				...
				AGENCIES_Kirki::add_field( $config, array(
					...
					'label'    => __( 'Top Border', 'agencies' ),
					'description'    => __( 'sub menu top border value in px', 'agencies' ),
					'section'  => 'dt_site_sub_menu_section',
				...
				AGENCIES_Kirki::add_field( $config, array(
					...
					'label'    => __( 'Right Border', 'agencies' ),
					'description'    => __( 'sub menu right border value in px', 'agencies' ),
					'section'  => 'dt_site_sub_menu_section',
					'choices'  => array( 'min'  => 1, 'max'  => 50, 'step' => 1 ),
					'output' => array( 
				...
				AGENCIES_Kirki::add_field( $config, array(
					...
					'label'    => __( 'Bottom Border', 'agencies' ),
					'description'    => __( 'sub menu bottom border value in px', 'agencies' ),
					'section'  => 'dt_site_sub_menu_section',
					'choices'  => array( 'min'  => 1, 'max'  => 50, 'step' => 1 ),
					'output' => array( 
				...
				AGENCIES_Kirki::add_field( $config, array(
					...
					'label'    => __( 'Left Border', 'agencies' ),
					'description'    => __( 'sub menu left border value in px', 'agencies' ),
					'section'  => 'dt_site_sub_menu_section',
					'choices'  => array( 'min'  => 1, 'max'  => 50, 'step' => 1 ),
					'output' => array( 
				...
				AGENCIES_Kirki::add_field( $config, array(
					...
					'label'    => __( 'Sub-Menu Wrapper Border Color', 'agencies' ),
					'section'  => 'dt_site_sub_menu_section',
					'choices' => array( 'alpha' => true ),
					'output' => array(
			...
			# Sub Menu Wrapper Border Radius
				...
				AGENCIES_Kirki::add_field( $config, array(
					...
					'label'    => __( 'Sub Menu Wrapper Radius?', 'agencies' ),
					'section'  => 'dt_site_sub_menu_section',
					'choices'  => array(
						'on'  => esc_attr__( 'Yes', 'agencies' ),
						'off' => esc_attr__( 'No', 'agencies' )
				...
				AGENCIES_Kirki::add_field( $config, array(
					...
					'label'    => __( 'Top Left Radius', 'agencies' ),
					'section'  => 'dt_site_sub_menu_section',
				...
				AGENCIES_Kirki::add_field( $config, array(
					...
					'label'    => __( 'Top Right Radius', 'agencies' ),
					'section'  => 'dt_site_sub_menu_section',
					'choices'  => array( 'min'  => 1, 'max'  => 100, 'step' => 1 ),
					'output' => array( 
				...
				AGENCIES_Kirki::add_field( $config, array(
					...
					'label'    => __( 'Bottom Right Radius', 'agencies' ),
					'section'  => 'dt_site_sub_menu_section',
					'choices'  => array( 'min'  => 1, 'max'  => 100, 'step' => 1 ),
					'output' => array( 
				...
				AGENCIES_Kirki::add_field( $config, array(
					...
					'label'    => __( 'Bottom Left Radius', 'agencies' ),
					'section'  => 'dt_site_sub_menu_section',
					'choices'  => array( 'min'  => 1, 'max'  => 100, 'step' => 1 ),
					'output' => array( 
			...
			# Sub Menu Wrapper Box Shadow	
				...
				AGENCIES_Kirki::add_field( $config, array(
					...
					'label'    => __( 'Sub Menu Wrapper Shadow?', 'agencies' ),
					'section'  => 'dt_site_sub_menu_section',
					'choices'  => array(
						'on'  => esc_attr__( 'Yes', 'agencies' ),
						'off' => esc_attr__( 'No', 'agencies' )
				...
				AGENCIES_Kirki::add_field( $config, array(
					...
					'label'    => __( 'H Shadow', 'agencies' ),
					'section'  => 'dt_site_sub_menu_section',
					'choices'  => array( 'min'  => 1, 'max'  => 50, 'step' => 1 ),
					'default'  => agencies_defaults('sub-menu-box-h-shadow'),
					'active_callback' => array(
						array( 'setting' => 'customize-sub-menu-wrapper', 'operator' => '==', 'value' => '1' ),
				...
				AGENCIES_Kirki::add_field( $config, array(
					...
					'label'    => __( 'V Shadow', 'agencies' ),
					'section'  => 'dt_site_sub_menu_section',
					'choices'  => array( 'min'  => 1, 'max'  => 50, 'step' => 1 ),			
					'default'  => agencies_defaults('sub-menu-box-v-shadow'),
					'active_callback' => array(
						array( 'setting' => 'customize-sub-menu-wrapper', 'operator' => '==', 'value' => '1' ),
						array( 'setting' => 'allow-sub-menu-box-shadow', 'operator' => '==', 'value' => '1' ),
					)
				...
				AGENCIES_Kirki::add_field( $config, array(
					...
					'label'    => __( 'Blur Shadow', 'agencies' ),
					'section'  => 'dt_site_sub_menu_section',
					'choices'  => array( 'min'  => 1, 'max'  => 50, 'step' => 1 ),			
					'default'  => agencies_defaults('sub-menu-box-blur-shadow'),
					'active_callback' => array(
						array( 'setting' => 'customize-sub-menu-wrapper', 'operator' => '==', 'value' => '1' ),
						array( 'setting' => 'allow-sub-menu-box-shadow', 'operator' => '==', 'value' => '1' ),
					)
				...
				AGENCIES_Kirki::add_field( $config, array(
					...
					'label'    => __( 'Spread Shadow', 'agencies' ),
					'section'  => 'dt_site_sub_menu_section',
					'choices'  => array( 'min'  => 1, 'max'  => 50, 'step' => 1 ),			
					'default'  => agencies_defaults('sub-menu-box-spread-shadow'),
					'active_callback' => array(
						array( 'setting' => 'customize-sub-menu-wrapper', 'operator' => '==', 'value' => '1' ),
						array( 'setting' => 'allow-sub-menu-box-shadow', 'operator' => '==', 'value' => '1' ),
					)
				...
				AGENCIES_Kirki::add_field( $config, array(
					...
					'label'    => __( 'Shadow Color', 'agencies' ),
					'section'  => 'dt_site_sub_menu_section',
					'active_callback' => array(
						array( 'setting' => 'customize-sub-menu-wrapper', 'operator' => '==', 'value' => '1' ),
						array( 'setting' => 'allow-sub-menu-box-shadow', 'operator' => '==', 'value' => '1' ),
				...
				AGENCIES_Kirki::add_field( $config, array(
					...
					'label'    => __( 'Box Shadow Inset?', 'agencies' ),
					'section'  => 'dt_site_sub_menu_section',
					'choices'  => array(
						'on'  => esc_attr__( 'Yes', 'agencies' ),
						'off' => esc_attr__( 'No', 'agencies' )
		...
		AGENCIES_Kirki::add_field( $config, array(
			...
			'label'    => __( 'Customize Sub Menu links ?', 'agencies' ),
			'section'  => 'dt_site_sub_menu_section',
			'default'  => 1,
			'choices'  => array(
				'on'  => esc_attr__( 'Yes', 'agencies' ),
		...
		# Sub Menu Link BG Settings
			...
			AGENCIES_Kirki::add_field( $config, array(
				...
				'label'    => __( 'Custom Colors - Sub Menu Links', 'agencies' ),
				'section'  => 'dt_site_sub_menu_section',
				'choices'  => array(
					'on'  => esc_attr__( 'Yes', 'agencies' ),
					'off' => esc_attr__( 'No', 'agencies' )
			...
			AGENCIES_Kirki::add_field( $config, array(
				...
				'label'    => __( 'Sub Menu Link Color', 'agencies' ),
				'section'  => 'dt_site_sub_menu_section',
				'output' => array(
			...
			AGENCIES_Kirki::add_field( $config, array(
				...
				'label'    => __( 'Sub Menu Link BG Color', 'agencies' ),
				'section'  => 'dt_site_sub_menu_section',
				'output' => array(
			...
			AGENCIES_Kirki::add_field( $config, array(
				...
				'label'    => __( 'Sub Menu Link Active Color', 'agencies' ),
				'section'  => 'dt_site_sub_menu_section',
				'output' => array(
			...
			AGENCIES_Kirki::add_field( $config, array(
				...
				'label'    => __( 'Sub Menu Link Active BG Color', 'agencies' ),
				'section'  => 'dt_site_sub_menu_section',
				'output' => array(
		...
		# Sub Menu Link Border Style
			...
			AGENCIES_Kirki::add_field( $config, array(
				...
				'label'    => __( 'Sub Menu Link Border', 'agencies' ),
				'section'  => 'dt_site_sub_menu_section',
				'choices'  => array(
					'-'	=> esc_html__('None','agencies'),
					'with-border'	=> esc_html__('With Border','agencies'),
					'with-hover-border'	=> esc_html__('With Hover Border','agencies'),
				),
				'active_callback' => array(
					array( 'setting' => 'customize-sub-menu-links', 'operator' => '==', 'value' => '1' )
				)				
				...
				# sub-menu-link-border-style  = with-hover-border
					...
					AGENCIES_Kirki::add_field( $config, array(
						...
						'label'    => __( 'Sub Menu Link Hover Border Style', 'agencies' ),
						'section'  => 'dt_site_sub_menu_section',
						'default'  => 'solid',
						'choices' => agencies_border_styles(),
						'output' => array(
					...
					AGENCIES_Kirki::add_field( $config, array(
						...
						'label'    => __( 'Sub Menu Link Hover Border Color', 'agencies' ),
						'section'  => 'dt_site_sub_menu_section',
						'choices' => array( 'alpha' => true ),
						'output' => array(
				...
				# sub-menu-link-border-style  = with-border
					...
					AGENCIES_Kirki::add_field( $config, array(
						...
						'label'    => __( 'Sub Menu Link Border Style', 'agencies' ),
						'section'  => 'dt_site_sub_menu_section',
						'default'  => 'solid',
						'choices' => agencies_border_styles(),
						'output' => array(
					...
					AGENCIES_Kirki::add_field( $config, array(
						...
						'label'    => __( 'Sub Menu Link Border Color ', 'agencies' ),
						'section'  => 'dt_site_sub_menu_section',
						'choices' => array( 'alpha' => true ),
						'output' => array(
		...
		# Sub Menu Link Border Radius
			...
			AGENCIES_Kirki::add_field( $config, array(
				...
				'label'    => __( 'Allow Sub Menu Link Radius?', 'agencies' ),
				'section'  => 'dt_site_sub_menu_section',
				'choices'  => array(
					'on'  => esc_attr__( 'Yes', 'agencies' ),
					'off' => esc_attr__( 'No', 'agencies' )
		...
		AGENCIES_Kirki::add_field( $config, array(
			...
			'label'    => __( 'Sub Menu Link Icon Style', 'agencies' ),
			'section'  => 'dt_site_sub_menu_section',
			'default' => agencies_defaults('sub-menu-style' ),
			'choices'  => array(
				''	=> esc_html__('None','agencies'),
				' menu-links-with-arrow single'	=> esc_html__('Single','agencies'),
				' menu-links-with-arrow double'	=> esc_html__('Double','agencies'),
				' menu-links-with-arrow disc'	=> esc_html__('Disc','agencies'),
			),
			'active_callback' => array(
				array( 'setting' => 'customize-sub-menu-links', 'operator' => '==', 'value' => '1' )
			)				
		...
		# Mega Menu	
			...
			AGENCIES_Kirki::add_field( $config, array(
				...
				'label'    => __( 'Customize Mega Menu title ?', 'agencies' ),
				'section'  => 'dt_site_sub_menu_section',
				'choices'  => array(
					'on'  => esc_attr__( 'Yes', 'agencies' ),
					'off' => esc_attr__( 'No', 'agencies' )
			...
			# Mega Menu Title Color
				...
				AGENCIES_Kirki::add_field( $config, array(
					...
					'label'    => __( 'Custom Colors - Mega Menu Title', 'agencies' ),
					'section'  => 'dt_site_sub_menu_section',
					'choices'  => array(
						'on'  => esc_attr__( 'Yes', 'agencies' ),
						'off' => esc_attr__( 'No', 'agencies' )
				...
				AGENCIES_Kirki::add_field( $config, array(
					...
					'label'    => __( 'Mega Menu Title Color', 'agencies' ),
					'section'  => 'dt_site_sub_menu_section',
					'output' => array(
				...
				AGENCIES_Kirki::add_field( $config, array(
					...
					'label'    => __( 'Mega Menu Title BG Color', 'agencies' ),
					'section'  => 'dt_site_sub_menu_section',
					'output' => array(
			...
			# Mega Menu Title Radius
				...
				AGENCIES_Kirki::add_field( $config, array(
					...
					'label'    => __( 'Allow Mega Menu Title Radius?', 'agencies' ),
					'section'  => 'dt_site_sub_menu_section',
					'choices'  => array(
						'on'  => esc_attr__( 'Yes', 'agencies' ),
						'off' => esc_attr__( 'No', 'agencies' )
			...
			# Mega Menu Title Border 
				...
				AGENCIES_Kirki::add_field( $config, array(
					...
					'label'    => __( 'Apply Mega Menu Title Border?', 'agencies' ),
					'section'  => 'dt_site_sub_menu_section',
					'choices'  => array(
						'on'  => esc_attr__( 'Yes', 'agencies' ),
						'off' => esc_attr__( 'No', 'agencies' )
				...
				AGENCIES_Kirki::add_field( $config, array(
					...
					'label'    => __( 'Mega Menu Title Border Style', 'agencies' ),
					'section'  => 'dt_site_sub_menu_section',
					'default'  => 'solid',
					'choices' => agencies_border_styles(),
					'output' => array(
				...
				AGENCIES_Kirki::add_field( $config, array(
					...
					'label'    => __( 'Mega Menu Title Border Color', 'agencies' ),
					'section'  => 'dt_site_sub_menu_section',
					'choices' => array( 'alpha' => true ),
					'output' => array(
