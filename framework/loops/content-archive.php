                                ...
                                <div class="entry-details">
                                   ...
                                   <?php if( !empty($allow_read_more) && !empty($read_more) ):
								   			if( shortcode_exists( 'dt_sc_button' ) && agencies_is_plugin_active('js_composer/js_composer.php') ):
												...
												echo '<a href="'.get_permalink().'" title="'.get_the_title().'" class="dt-sc-button small icon-right with-icon filled type1 dt-sc-readmore-link">'.esc_html__('Read More', 'agencies').'<span class="fa fa-long-arrow-right"> </span></a>';
											endif;
